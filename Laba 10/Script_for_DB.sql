...
(
 AUDITORIUM           nchar(10) primary key,  -- êîä àóäèòîðèè
 AUDITORIUM_NAME      nvarchar2(200),          -- àóäèòîðèÿ
 AUDITORIUM_CAPACITY  number(4),              -- âìåñòèìîñòü
 AUDITORIUM_TYPE      nchar(10) not null      -- òèï àóäèòîðèè
